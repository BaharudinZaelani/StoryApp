...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    // action
    private fun mapOpt(mMap: GoogleMap) {
    ...
    private fun fetchDataStory() {
        viewModel.getSession().observe(this){user ->
            lifecycleScope.launch {
                try {
                    val apiService = ApiConfig().getApiServiceAuth(user.token)
                    ...
                    Toast.makeText(this@MapsActivity, "Error saat membuat mark !", Toast.LENGTH_SHORT).show()
